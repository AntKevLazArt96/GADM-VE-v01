                            ...
                            public void run() {
                            	try {
									...
									for (int i = 0; i < lista.size(); i++) {
										...
										if(lista.size()==3) {
											img3.setImage(convertirImg(lista.get(3).getImg()));
										...
										if(lista.size()==4) {
											img4.setImage(convertirImg(lista.get(4).getImg()));
										...
										if(lista.size()==5) {
											img5.setImage(convertirImg(lista.get(5).getImg()));
										...
										if(lista.size()==6) {
											img6.setImage(convertirImg(lista.get(6).getImg()));
